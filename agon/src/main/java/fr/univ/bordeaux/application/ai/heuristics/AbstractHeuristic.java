 ...
 * <p>
 * This class implements the <b>Template Method pattern</b> to factorize the common logic
 * of iterating over the board, applying weights to pieces, and calculating the differential score
 * (AI score minus Opponent score).
 * </p>
 * <p>
 * Concrete subclasses only need to implement the specific {@link #getFactor(AgonBoard, int)} method
 * to define the raw metric (e.g., centrality, mobility).
 * </p>
 */
public abstract class AbstractHeuristic implements Heuristic {
    ...
    /**
     * The weight multiplier applied to the raw factor for the Queen.
     * Usually significantly higher than {@link #pawnWeight} to reflect the Queen's importance.
     */
     ...
     * (e.g., calculating distance to center, counting legal moves, etc.).
     * </p>
     *
     ...
     * {@inheritDoc}
     * <p>
     * <b>Implementation Note:</b> This implementation uses the <b>Template Method</b> pattern.
     * It iterates over all 91 cells of the board, calculates a specific factor using
