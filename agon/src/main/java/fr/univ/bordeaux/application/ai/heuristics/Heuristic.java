 ...
 * <p>
 * In game theory and AI, a heuristic is used to estimate the value of a game state (a node in the game tree)
 * without exploring the tree all the way to the end of the game.
 * </p>
 * <p>
 * This interface is the core of the <b>Strategy Pattern</b> used in this project. It allows the AI
 * to switch between different evaluation strategies (e.g., Centrality, Mobility, Mixed) dynamically.
 * </p>
 */
