...
/**
 * transform {@link Options} from Apache Commons Cli
 * into a completer for JLine {@link Completer}
 * @version 1
 * future improvements : use treemap with the origin as no default
 * completer separated with 2 branches (first fore commands possibilities next
 * layers for option and final layer for arguments)
 * but it can be used in other different situations
 */
public class OptCompleterAdapter {
  ...
  public Completer getCompleter(String cmdName) {
    ...
    return new ArgumentCompleter(
      ...
      new StringsCompleter(followingTxt)
    );
  }
