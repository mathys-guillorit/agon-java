 ...
 * <p>
 * Each direction is associated with an integer offset (v) used to navigate
 * the 1D array representation of the 2D hexagonal board. These offsets
 * are specifically designed for an 11-column axial coordinate mapping.
 * </p>
 */
public enum Direction {
   ...
   * * @param v The integer value to add to an index to move in this direction.
   */
  Direction(int v) {
    this.v = v;
  }
   ...
   * <p>
   * This is primarily used for capture logic (detecting "sandwiches"), where
   * an enemy piece must be flanked by two friendly pieces in opposite directions.
   * </p>
   *
