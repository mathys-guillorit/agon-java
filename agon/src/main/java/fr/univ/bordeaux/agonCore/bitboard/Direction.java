 ...
 *
 * <p>Each direction is associated with an integer offset (v) used to navigate the 1D array
...
public enum Direction {
   ...
   *
   * <p>This is primarily used for capture logic (detecting "sandwiches"), where an enemy piece must
   * be flanked by two friendly pieces in opposite directions.
   *
