...
public class AgonGuiTest {
        ...
        Platform.runLater(
                () -> {
                    try {
                        ...
                        for (Window window :
                                new java.util.ArrayList<>(Window.getWindows())) {
    ...
    void testOnMatchUpdate_BlitzMatch_Timeline() throws InterruptedException {
        ...
        // CORRECTION ICI : On vérifie la présence du texte, peu importe les secondes (04:59, 10:00, etc.)
        assertTrue(fakeController.lastMessage.contains("Time left:"));
