...
class CoordinateMapperTest {
    ...
    void testFromCoordinateString() {
        assertEquals(24, CoordinateMapper.fromCoordinateString("c3"), "Lowercase 'c3' should map to index 24");
        assertEquals(24, CoordinateMapper.fromCoordinateString("C3"), "Uppercase 'C3' should map to index 24");

        assertEquals(60, CoordinateMapper.fromCoordinateString("f6"), "'f6' should map to the Throne (60)");
    ...
    void testSymmetry() {
        ...
        for (int originalIndex : criticalIndices) {
            ...
            assertEquals(originalIndex, restoredIndex,
