...
public class LoadLocalFileTest {
    ...
    /**
     * Verifies that the loader correctly applies the fallback mechanism
     * when a resource file cannot be found.
     * <p>
     * This test ensures that if the input stream is null (e.g., the file does
     * not exist), the provided default content is used instead.
     */
    @Test
    public void testLoadLocalFileWithNullStream() throws IOException {
        ...
        assertEquals("", loader.getContent(),
