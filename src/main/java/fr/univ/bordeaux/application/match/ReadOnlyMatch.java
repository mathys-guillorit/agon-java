...
/**
 * Provides a read-only view of a match state.
 * This interface is intended for use by UI components (Observers)
 * to prevent accidental state modifications during updates.
 */
