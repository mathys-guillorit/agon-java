 ...
 * <ul>
 *     <li>{@code join} → connect to default localhost:12345</li>
 *     <li>{@code join 192.168.1.10}</li>
 *     <li>{@code join 192.168.1.10:12345}</li>
 * </ul>
 *
 * <p>The command ensures:
 * <ul>
 *     <li>Disconnection if a dead connection exists</li>
 *     <li>Safe parsing of host and port</li>
 *     <li>User feedback via UI</li>
 * </ul>
 */
    ...
    private boolean run(String[] args) {
        ...
        if (args != null && args.length > 0 && !args[0].isBlank()) {
            ...
            if (colonIndex != -1) {
                ...
                if (!hostPart.isEmpty()) host = hostPart;
