 ...
 * <ul>
 *   <li>LOCAL mode → starts a local game using the existing {@link CmdCreate} logic</li>
 *   <li>ONLINE mode → sends a request to the server to start a game with another player</li>
 * </ul>
 *
 * <p>Usage:
 * <ul>
 *   <li>{@code new [LOCAL_OPTIONS]} → starts a local game</li>
 *   <li>{@code new PLAYER_ID} → starts an online game with the specified player</li>
 * </ul>
 *
 * <p>This command:
 * <ul>
 *   <li>Checks the current application mode</li>
 *   <li>Delegates to {@link CmdCreate} in local mode</li>
 *   <li>Validates the target player ID in online mode</li>
 *   <li>Sends a NEW request to the connected server</li>
 * </ul>
 */
public class CmdNew extends Cmd {
     ...
     */
    public CmdNew(GameUserInterface ui, AppContext context, GameConfig gameConfig, GameEngine gameEngine) {
        super(ui);
     ...
     *
     * <p>In LOCAL mode, this delegates to {@link CmdCreate}. In ONLINE mode,
     * this validates the arguments and sends a request to the server.
     *
     * @param args command arguments
     * @param match current match manager
     * @return true if execution completed successfully
