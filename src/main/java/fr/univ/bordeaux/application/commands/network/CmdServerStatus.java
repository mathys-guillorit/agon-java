 ...
 * <p>This command:
 * <ul>
 *     <li>Displays local server information if a local server is running</li>
 *     <li>Requests remote server status if connected as a client</li>
 *     <li>Shows port, number of connected clients, connected players, and active games</li>
 * </ul>
 */
