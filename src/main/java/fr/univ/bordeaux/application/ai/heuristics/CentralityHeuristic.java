 ...
 * <p>
 * This heuristic encourages the AI to move its pieces towards the center of the board (the Throne).
 * Unlike a linear approach, this implementation uses a <b>Quadratic function</b> to calculate the score.
 * This means that the value of a square increases exponentially as it gets closer to the center,
 * creating a strong "gravity" effect that prioritizes the inner rings over the outer rings.
 * </p>
 */
