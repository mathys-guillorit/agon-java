 ...
 * <p>
 * This strategy constructs a game tree to a specified depth and evaluates the terminal nodes using
 * the injected {@link Heuristic}.
 * </p>
 * <p>
 * If Iterative Deepening is enabled, the algorithm searches progressively deeper (depth 1, then 2,
 * etc.) until the maximum depth is reached or the time limit is exceeded. This ensures a valid move
 * is always ready even if the computation is interrupted.
 * </p>
 */
public class MinimaxStrategy extends AbstractAgonAI {
   ...
   */
  public MinimaxStrategy(Heuristic heuristic, Color color, int maxDepth, boolean iterativeDeepening,
   ...
   */
  private long minimax(AgonBoard board, int depth, boolean isMaximizingPlayer, long alpha,
      long beta, long startTime) {
