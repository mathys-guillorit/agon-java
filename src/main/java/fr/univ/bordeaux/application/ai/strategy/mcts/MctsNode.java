 ...
 * and the specific move that led to this node's creation. It is designed to be memory-efficient
 * by strictly holding the move applied rather than cloning the entire board state.</p>
 */
public class MctsNode {

    /**
     * The parent node of this node in the MCTS tree.
     * This is {@code null} if this node is the root of the tree.
     */
    ...
    /**
     * The specific move that was applied to the parent's state to reach this node's state.
     * This is {@code null} for the root node.
     */
     ...
     * <p>This method increments the visit count and adds the rollout score to the total win score.</p>
     *
     * @param score The outcome of the simulation (e.g., 1.0 for a win, 0.0 for a loss, 0.5 for a draw).
     */
     ...
     * <p>This method is utilized primarily during the Expansion phase of the MCTS algorithm.</p>
     *
