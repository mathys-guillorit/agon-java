 ...
 * <ul>
 *   <li>the display name chosen by the user,</li>
 *   <li>a unique client identifier used for server-side reconnection,</li>
 *   <li>the player IDs assigned by each connected server.</li>
 * </ul>
 *
 * <p>The display name is not used as a unique identity because
 * multiple users may share the same name.
 */
public class LocalProfile {
     ...
     *
     * <p>This identifier is sent to the server during LOGIN
     * and is used to distinguish clients even if they have the same name.
     *
