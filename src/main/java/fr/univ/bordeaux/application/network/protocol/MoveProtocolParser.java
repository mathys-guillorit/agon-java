 ...
 * <ul>
 *   <li>a normal move: [letter][1 or 2 digits][letter][1 or 2 digits]</li>
 *   <li>a replacement move: [letter][1 or 2 digits]</li>
 * </ul>
 */
public final class MoveProtocolParser {

    /**
     * Pattern matching a compact normal move:
     * source letter + source number + destination letter + destination number.
     */
    private static final Pattern FULL_MOVE_PATTERN =
            Pattern.compile("^([a-kA-K])(\\d{1,2})([a-kA-K])(\\d{1,2})$");

    /**
     * Pattern matching a compact replacement move:
     * destination letter + destination number.
     */
    private static final Pattern SHORT_MOVE_PATTERN =
            Pattern.compile("^([a-kA-K])(\\d{1,2})$");
