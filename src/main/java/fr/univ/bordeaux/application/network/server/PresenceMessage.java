...
public class PresenceMessage {
   ...
   */
  public PresenceMessage(String serverName, int tcpPort) {
   ...
   */
  public byte[] toBytes() {
    String msg = "name=" + serverName + ";tcp=" + tcpPort;
   ...
   */
  public static PresenceMessage parse(byte[] data, int length) {

    String msg = new String(data, 0, length, StandardCharsets.US_ASCII);
    ...
    return new PresenceMessage(name, tcp);
  }
}
