...
public class AiDuel {
    ...
    public static void main(String[] args) {
        System.out.println("=== AI Duel: ML vs UCT ===");
        ...
        AbstractAgonAi whiteAi = new MctsStrategy(Color.WHITE, mlHeuristic, 2);

        System.out.println("[Initialization] Black Player: UCT MCTS");
        UctHeuristic uct = new UctHeuristic(Math.sqrt(2));
        AbstractAgonAi blackAi = new MctsStrategy(Color.BLACK, uct, 2);
