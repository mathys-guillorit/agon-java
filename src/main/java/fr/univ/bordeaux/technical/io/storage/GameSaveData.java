...
public class GameSaveData {
    ...
    public GameSaveData(GameConfig config, Color currentPlayer, List<String> boardLines, List<String> historyMoves) {
        this.config = config;
    ...
    public List<String> getBoardLines() { return boardLines; }
    public List<String> getHistoryMoves() { return historyMoves; }
}