...
public class GameSaveBuilder {
    ...
    public GameConfig getConfig() { return config; } // Useful to reuse ConfigParser logic

    public void setCurrentPlayer(Color player) { this.currentPlayer = player; }

    public void addBoardLine(String line) { this.boardLines.add(line); }

    public void addHistoryMove(String move) { this.historyMoves.add(move); }
