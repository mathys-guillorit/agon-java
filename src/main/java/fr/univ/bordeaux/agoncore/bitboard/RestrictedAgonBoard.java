<<<<<<< HEAD:src/main/java/fr/univ/bordeaux/agonCore/bitboard/RestrictedAgonBoard.java
 ...
 *
 * <p>This interface is designed for components that need to inspect the board
 * or calculate potential actions without having the authority to modify the game state directly.</p>
 */
public interface RestrictedAgonBoard {
  /**
   * Generates a complete list of all legal moves for the specified player.
   *
   * <p>The method accounts for the current game state, including:</p>
   * <ul>
   ...
   * * <p>This is a helper method used to inspect the board state without
   * direct bitboard manipulation.</p>
   *
   * @param index The tile index (0 to 120) to inspect.
   * @return The {@link PieceType} at the given index, or {@code null}
   * if the tile is empty or the index is out of bounds.
   */
...
>>>>>>> main:src/main/java/fr/univ/bordeaux/agoncore/bitboard/RestrictedAgonBoard.java
