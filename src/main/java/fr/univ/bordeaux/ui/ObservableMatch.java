 ...
 *
 * <p>This interface allows an external observer to register itself to receive 
 * updates. It ensures a decoupled relationship between the game logic 
 * and the display logic, following the Observer design pattern.</p>
 */
public interface ObservableMatch {
   ...
   * * <p>This is typically called after a significant state change (like a move 
   * or a game reset) to ensure the user interface reflects the most 
   * current board configuration.</p>
   */
  void notifyUi();
}