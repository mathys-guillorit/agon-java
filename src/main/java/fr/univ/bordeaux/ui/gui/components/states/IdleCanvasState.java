...
public class IdleCanvasState implements CanvasInteractionState{
    @Override
    public void handleMousePressed(CanvasInterface canvas, String agonCoordinate, double x, double y) {
    ...
    @Override
    public void handleMouseReleased(CanvasInterface canvas, String agonCoordinate, double x, double y) {}
}
